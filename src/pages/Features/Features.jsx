        ...
        <div className="flex flex-col">
            <div className="relative">
                <div className="min-h-screen">
                    <img src={Background} className="brightness-50 w-full h-full min-h-screen object-cover"/>
                </div>

            
                <div className="flex flex-col absolute inset-0 m-auto h-fit text-center px-4">
                    <div className="text-blue-100 text-3xl sm:text-6xl font-bold"><p>Sailing Debrief</p></div>
                    <div className="text-gray-300 text-base sm:text-xl font-bold"><p>A desktop application for teams and coaches. Pair video and audio with GPS and boat telemetry on a single timeline.</p></div>
                </div>
            </div>

            <div className="bg-gray-200 p-6 lg:p-12 flex flex-col items-center text-center">
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-center mt-5 mb-5 px-4">
                <FeatureCard
            ...
            <div className="p-6 lg:p-12 flex flex-col lg:flex-row items-center text-center lg:text-left gap-6">
                <div className="flex flex-col">
                    <p className="text-3xl font-bold">Telemetry Graphs</p>
                    <p className="max-w-prose">Overlay your training partners data on a graph to compare or view your telemetry over a period of time.</p>
                </div>
