...
import { downloadMacM, downloadMacIntel, downloadWindows } from "../../constants/downloadUrl";
const Download = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <DownloadCard title={'MacOs Intel'} filePath={downloadMacIntel} />
                <DownloadCard title={'MacOs M-Series'} filePath={downloadMacM} />
                <DownloadCard title={'Windows 10 & 11'} filePath={downloadWindows} buttonHandler={() => setShowWin(true)}/>
