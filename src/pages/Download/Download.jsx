    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <DownloadCard title={'MacOs Apple Silicon'} filePath={'https://github.com/tommytunes/Sailing-Debrief-Website/releases/download/1.2.3/Sailing.Debrief-1.2.2-arm64.dmg'} />
